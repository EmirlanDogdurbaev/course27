...
from .models import Model_all_books, Model_notes_of_user


def home(request):
    books = Model_all_books.objects.all()[::-1]
    books = books[:9]
    context = {
        'books': books,
    }
...
def detail(request, book_id):
    # book = get_object_or_404(Model_all_books, id=book_id)
    book = Model_all_books.objects.get(id=book_id)
